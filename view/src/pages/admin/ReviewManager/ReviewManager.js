...
const ReviewManager = () => {
  ...
  const filteredReviews = reviews.filter((review) => {
    ...
    const matchesStatus =
      statusFilter === "all" ||
      (statusFilter === "approved" && review.status === 1) ||
      (statusFilter === "unapproved" && review.status === 0);
  ...
  const handleSearchChange = (e) => {
    ...
    setCurrentPage(1); // Reset halaman ke awal saat pencarian berubah
  };
    ...
    <Container>
          ...
          <Col xs="auto" className="d-flex">
            ...
            >
              ...
              <FormControl
                ...
                aria-label="Search"
                value={searchTerm}
                onChange={handleSearchChange} // Gunakan fungsi handleSearchChange
              />
            </InputGroup>
          </Col>
      ...
      >
        <Modal.Header closeButton>
          <Modal.Title>
            {modalType === "approve" ? "Approve Review" : "Delete Review"}
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
          {modalType === "approve" ? (
        ...
        <Modal.Footer>
          ...
          <Button
            ...
            onClick={() => {
              modalType === "approve"
                ? approveReview(selectedReview.review_id)
                : softDeleteReview(selectedReview.review_id);
            }}
          >
      ...
      >
        ...
        <Modal.Body>
          <p>
            <strong>Review ID:</strong> {selectedReview?.review_id}
          </p>
          <p>
            <strong>User Name:</strong> {selectedReview?.user_name}
          </p>
          <p>
            <strong>Movie Title:</strong> {selectedReview?.movie_title}
          </p>
          <p>
          ...
          <p>
            ...
            {selectedReview?.status === 1 ? "Approved" : "Unapproved"}
          </p>
          <p>
